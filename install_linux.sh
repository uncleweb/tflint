...
get_latest_release() {
  curl --silent "https://api.github.com/repos/uncleweb/tflint/releases/latest" | # Get latest release from GitHub api
...
curl -L -o /tmp/tflint.zip "https://github.com/uncleweb/tflint/releases/download/${latest_version}/tflint_${os}.zip"
retVal=$?
if [ $retVal -ne 0 ]; then
